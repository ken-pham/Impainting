...
class TrainOptions :
    ...
    def initialize (self) :
        ...
        self.parser.add_argument ('--buffer_size', type=int, default=50000, help='buffer size for data')

        self.parser.add_argument ('--random_mask', type=int, default=1, help='0 -> Center 128 * 128 mask, 1 -> random mask')
        ...
        self.parser.add_argument ('--decay_steps', type=int, default=5000)

        self.parser.add_argument ('--image_shape', type=str, default='512,512,3')
