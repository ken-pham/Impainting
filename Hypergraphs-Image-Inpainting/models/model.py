...
class Model () :
    def build_generator (self, input_height, input_width) :
        ...
        x = GatedConvolution (channels=64, kernel_size=3, stride=1, dilation=1, padding='same', activation='ELU') (x)
        x = GatedConvolution (channels=32, kernel_size=3, stride=1, dilation=1, padding='same', activation='ELU') (x)
